...
public final class ImageUtils {
	...
	private static void zoomImageUtils(File imageFile, String newPath,
		...
		// 处理 png 背景变黑的问题
		if (suffix != null
				&& (suffix.trim().toLowerCase().endsWith("png") || suffix
						.trim().toLowerCase().endsWith("gif"))) {
	 ...
	 * @throws IOException
	 */
	public static void constrainProportios(int nw, String oldImage)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void zoomImage(File imageFile, String newPath, int width,
	...
	public static void main(String[] args) throws IOException {
		String name = "/Users/wushou/nfs/111111.jpg";
		File file = new File(name);

		zoomImageScale(file, "/Users/wushou/nfs/111222.jpg", 680);
	}
